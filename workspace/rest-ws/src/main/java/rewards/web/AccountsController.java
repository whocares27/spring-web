...
public class AccountsController {
	...
	@RequestMapping(method=POST, consumes={"application/json"})
		...
		@RequestBody Account newAccount, UriComponentsBuilder ucb) {
		rewardsApplicationService.saveAccount(newAccount);
		HttpHeaders headers = new HttpHeaders();
		headers.setLocation(ucb.path("/accounts/{id}").buildAndExpand(newAccount.getNumber()).toUri());
